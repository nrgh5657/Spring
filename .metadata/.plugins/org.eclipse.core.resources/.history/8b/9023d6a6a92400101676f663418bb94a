...
<body>
   <div id="wrap" align="center">
      ...
      <br> <br> 
      <input type="button" value="게시글 수정"  onclick="open_win('/board/checkPassForm?num=${board.num}', 'update')">
      <input type="button" value="게시글 삭제"  onclick="open_win('/board/checkPassForm?num=${board.num}', 'delete')">
